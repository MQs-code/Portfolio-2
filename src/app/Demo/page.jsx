      ...
      <main className="min-h-screen w-full">
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 py-16 md:py-20 bg-white gap-12 lg:gap-0">
          ...
          >
            ...
            <div className="pt-4">
              <button onClick={()=> setshowpop(!showpop)} className="w-full sm:w-auto bg-green-900 text-white py-4 px-10 rounded-full text-xs font-bold uppercase tracking-[0.2em] hover:bg-green-800 transition-all shadow-xl shadow-green-900/20 active:scale-95">
                Start Shopping Soon
              </button>
            </div>
          </motion.div>
